...
#define api_drawPoint(mod, c, x, y)					DB(0xfc,0xfe,0x10); R30=0x0002; R31=mod; R32=c; R33=x; R34=y; PCALL(P28) 
#define api_drawLine(mod, c, x0, y0, x1, y1)		DB(0xfc,0xfe,0x10); R30=0x0003; R31=mod; R32=c; R33=x0; R34=y0; R35=x1; R36=y1; PCALL(P28) 
#define api_fillRect(mod, c, xsiz, ysiz, x0, y0)	DB(0xfc,0xfe,0x10); R30=0x0004; R31=mod;      R32=c; R33=xsiz; R34=ysiz; R35=x0; R36=y0; PCALL(P28) 
#define api_drawRect(mod, c, xsiz, ysiz, x0, y0)	DB(0xfc,0xfe,0x10); R30=0x0004; R31=mod|0x20; R32=c; R33=xsiz; R34=ysiz; R35=x0; R36=y0; PCALL(P28) 
#define api_fillOval(mod, c, xsiz, ysiz, x0, y0)	DB(0xfc,0xfe,0x10); R30=0x0005; R31=mod;      R32=c; R33=xsiz; R34=ysiz; R35=x0; R36=y0; PCALL(P28) 
#define api_drawOval(mod, c, xsiz, ysiz, x0, y0)	DB(0xfc,0xfe,0x10); R30=0x0005; R31=mod|0x20; R32=c; R33=xsiz; R34=ysiz; R35=x0; R36=y0; PCALL(P28) 
#define api_openWin(xsiz, ysiz)						DB(0xfc,0xfe,0x10); R30=0x0010; R31=xsiz; R32=ysiz; PCALL(P28)
...
#define junkApi_drawString2(mod, xsiz, ysiz, x0, y0, c, len, s)		DB(0xfe,0x05,0x01); DDBE(0x0006); R30=0xff48; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=c; DB(0xff,0x02,0x02); R37=len; P31=s; PCALL(P28)
#define junkApi_rand(_r, range)						DB(0xfe,0x05,0x01); DDBE(0x0013); R30=0xff49; R31=range; PCALL(P28); _r=R30
#define junkApi_putStringDec0(s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0016); R30=0xff09; DB(0xff,0x00,0x00); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,-1,width,opt,-16-(reg&0x3f)); PCALL(P28)
#define junkApi_putStringDec6(s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0016); R30=0xff09; DB(0xff,0x00,0x06); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,-1,width,opt,-16-(reg&0x3f)); PCALL(P28)
#define junkApi_drawStringDec0(mod, xsiz, ysiz, x0, y0, c, s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0017); R30=0xff4c; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=c; DB(0xff,0x00,0x00); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,-1,width,opt,-16-(reg&0x3f)); PCALL(P28) 
#define junkApi_drawStringDec6(mod, xsiz, ysiz, x0, y0, c, s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0017); R30=0xff4c; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=c; DB(0xff,0x00,0x06); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,-1,width,opt,-16-(reg&0x3f)); PCALL(P28) 
#define junkApi_putStringHex0(s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0016); R30=0xff09; DB(0xff,0x00,0x00); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,0,width,opt,-16-(reg&0x3f)); PCALL(P28)
#define junkApi_putStringHex6(s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0016); R30=0xff09; DB(0xff,0x00,0x06); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,0,width,opt,-16-(reg&0x3f)); PCALL(P28)
#define junkApi_drawStringHex0(mod, xsiz, ysiz, x0, y0, c, s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0017); R30=0xff4c; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=c; DB(0xff,0x00,0x00); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,0,width,opt,-16-(reg&0x3f)); PCALL(P28) 
#define junkApi_drawStringHex6(mod, xsiz, ysiz, x0, y0, c, s, reg, width, opt)	DB(0xfe,0x05,0x01); DDBE(0x0017); R30=0xff4c; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=c; DB(0xff,0x00,0x06); DB%(s,0x00); DB(0xff,0x03,0x01); DDBE(4,0,width,opt,-16-(reg&0x3f)); PCALL(P28) 
...
#define junkApi_putString2(len, s)					DB(0xfe,0x05,0x01); DDBE(0x0001); R30=0xff07; DB(0xff,0x02,0x02); R31=len; P31=s; PCALL(P28)
...
#define junkApi_drawChar(mod, xsiz, ysiz, x0, y0, col, ch)	R38=ch; DB(0xfe,0x05,0x01); DDBE(0x0006); R30=0xff48; R31=mod; R32=xsiz; R33=ysiz; R34=x0; R35=y0; R36=col; DB(0xff,0x01,0x04); DDBE(-16-0x38,0); PCALL(P28) 
#define junkApi_malloc(_p, typ, len)				R38=typ; R39=len; DB(0x32,_p&0x3f,0x38,0x39)
#define junkApi_jitc2(_rc, _p, mod, lev, di1, len, s)	R30=0xff08; R31=mod; R32=lev; R33=di1; R34=len; P31=s; PCALL(P28); _rc=R30; _p=P31

#define junkApi_bitblt(mod, xsiz, ysiz, xscale, yscale, x0, y0, lineskip, inv, p_buf, typ0, p_table, typ1)	DB(0xfe,0x05,0x01); DDBE(0x0018); R30=0xff4d; R31=mod; R32=xsiz; R33=ysiz; R34=xscale; R35=yscale; R36=x0; R37=y0; R38=lineskip; R39=inv; R3A=typ0; R3B=typ1; P31=p_buf; P32=p_table; PCALL(P28)
...
#define	LMEM0PP(bit, reg, typ, preg)	LMEM(bit, reg, typ, preg, 0); PADDI(bit, preg, typ, preg, 1)
#define SMEM0PP(bit, reg, typ, preg)	SMEM(bit, reg, typ, preg, 0); PADDI(bit, preg, typ, preg, 1)
...
#define PAPLMEM(preg0, typ32, preg1, reg1, mclen)	PADD(P3F, typ32, preg1, reg1); PLMEM(preg0, typ32, P3F, mclen)
#define PAPSMEM(preg0, typ32, preg1, reg1, mclen)	PADD(P3F, typ32, preg1, reg1); PSMEM(preg0, typ32, P3F, mclen)
